...
Une fois l'image chargée sur notre serveur, on lance l'installation de la machine virtuelle, seule différence, il faut installer les drivers VirtIO pour que l'installation trouve le disque dur.
